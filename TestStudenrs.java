...
public class TestStudenrs {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        ArrayList<StudentsClass> base = new ArrayList<StudentsClass>();
        while(true){
...
//addstudnets
    public static void addStudent(ArrayList<StudentsClass> base) {
        for (int i = 0; i < 1; i++) {
            Scanner sc = new Scanner(System.in);
            ...
            StudentsClass s1 = new StudentsClass(name, roll, grade,science, math, java, database, business, total, school, dob, gender);
    ...
    public static int getIndex(ArrayList<StudentsClass> base, int roll) {

        int index = -1;

        for (int i = 0; i < base.size(); i++) {
            StudentsClass s1= base.get(i);
    ...
    public static void queryStudents(ArrayList<StudentsClass> base) {
    ...
    public static void deleteStudent(ArrayList<StudentsClass> base) {
    ...
    public static void updateStudent(ArrayList<StudentsClass> base) {
        ...
        if (index == -1) {
            ...
            StudentsClass s1 = new StudentsClass(name, roll, grade, science, maths, java, database, business, total, school, dob, gender);
